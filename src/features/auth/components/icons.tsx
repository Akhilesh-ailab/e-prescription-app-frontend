...
export function StethoscopeIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h.01M15 12h.01M9 6v6a3 3 0 003 3v0a3 3 0 003-3V6M9 6a2 2 0 012-2h2a2 2 0 012 2M4.5 8.5a2 2 0 100-4 2 2 0 000 4zM4.5 8.5V13a7.5 7.5 0 0011.4 6.4M19.5 15a2 2 0 100-4 2 2 0 000 4z" />
    </svg>
  );
}
...
export function CaduceusIcon({ className = "w-full h-full" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 100 140">
      <line x1="50" y1="10" x2="50" y2="130" strokeWidth="3" />
      <path d="M50 25 C20 35, 20 55, 50 65 C80 75, 80 95, 50 105" strokeWidth="2.5" fill="none" />
      <path d="M50 25 C80 35, 80 55, 50 65 C20 75, 20 95, 50 105" strokeWidth="2.5" fill="none" />
      <path d="M20 15 L50 25 L80 15" strokeWidth="3" fill="none" strokeLinecap="round" />
